const questions = {
  htmleasy: [
    ...
    {
      question:
        "Which of the following is not an element associated with the HTML table layout?",
    ...
    {
      question:
        "Which attribute is used to merge two or more table cells horizontally in HTML?",
  ...
  htmlmedium: [
    ...
    {
      question:
        "Which HTML attribute is used to specify inline styles for an element?",
    ...
    {
      question:
        "What is the correct way to define a list where the items are numbered?",
    ...
    {
      question:
        "Which HTML element is used to specify that the text inside it is important?",
    ...
    {
      question:
        "Which attribute is used to specify the allowed file types in an input field of type 'file'?",
    ...
    {
      question:
        "How do you set a background image for an HTML page using inline CSS?",
      possibleAnswers: [
    ...
    {
      question:
        "How can you specify the relationship between the current document and an external file?",
    ...
    {
      question:
        "Which attribute is used in the <form> element to send form data to a server?",
    ...
    {
      question:
        "Which attribute is used to specify the type of button in HTML?",
    ...
    {
      question:
        "Which HTML element is used to display text in a fixed-width font?",
    ...
    {
      question:
        "What is the correct way to refer to an external style sheet in HTML?",
      possibleAnswers: [
    ...
    {
      question:
        "Which HTML tag is used to embed an object, such as a Flash animation, in a webpage?",
    ...
    {
      question:
        "How can you align an image to the right of a webpage using HTML?",
      possibleAnswers: [
        "<img align='right'>",
        "<img style='right'>",
        "<img float='right'>",
  ...
  htmlhard: [
    {
      question:
        "Which attribute can be used to create responsive images in HTML5?",
    ...
    },
    {
      ...
      possibleAnswers: [
        "To provide fallback content when JavaScript is disabled",
        "To embed scripts",
    ...
    {
      question:
        "Which element is used to group content together in HTML5, especially for styling and scripting purposes?",
    ...
    },
    {
      ...
      possibleAnswers: [
        "Provides multiple sources for responsive images",
        "Defines an image",
    ...
    {
      question:
        "How can you specify multiple background images for an element in CSS via inline style?",
      possibleAnswers: [
        "style='background-image: url(img1), url(img2)'",
        "style='backgrounds: url(img1), url(img2)'",
        "style='multiple-bg: url(img1), url(img2)'",
      ],
    ...
    },
    {
      ...
      possibleAnswers: [
        "To create a collapsible content section",
        "To store metadata",
        "To define extra content like footnotes",
      ],
    ...
    },
    {
      ...
      possibleAnswers: [
        ...
        "createWorker('script.js')",
        "startWorker('script.js')",
      ],
    ...
    },
    {
      ...
      possibleAnswers: [
        ...
        "Delays script execution by a set time",
        "Prevents script execution on page load",
      ],
      correctAnswer:
        "Defers script execution until the document has been parsed",
    ...
    {
      question:
        "Which element is used to display machine-readable contact information in HTML5?",
    ...
    {
      question:
        "Which attribute of the <input> element is used to define whether multiple files can be selected in a file upload?",
    ...
    {
      question:
        "Which HTML tag is used to define a container for external applications or interactive content?",
    ...
    {
      question:
        "Which new HTML5 element is used to define self-contained content?",
    ...
    },
    {
      ...
      possibleAnswers: [
        ...
        "Checks the form for syntax errors",
      ],
      correctAnswer:
        "Specifies whether a form or input field should have autocomplete enabled",
    ...
    },
    {
      ...
      possibleAnswers: [
        "To generate a key pair for form submissions",
    ...
    {
      question:
        "Which attribute of the <form> element is used to specify an HTTP method to send form data?",
    ...
    {
      question:
        "Which HTML5 element is used for media playback in a web browser?",
    ...
    {
      question:
        "How do you indicate that an <input> element should be read-only?",
    ...
    {
      question:
        "Which attribute in HTML5 <input> tag is used to associate an input with a datalist?",
    ...
    {
      question:
        "Which input type allows for the selection of a month in HTML5?",
    ...
    },
    {
      ...
      possibleAnswers: [
        "To group media and caption content",
        "To represent statistics",
        "To embed videos",
      ],
    ...
    {
      question:
        "Which HTML5 element is used to define a scalar value within a known range?",
      possibleAnswers: ["<meter>", "<progress>", "<input>"],
      correctAnswer: "<meter>",
    ...
    },
    {
      ...
      possibleAnswers: [
        "Asynchronously loads the script",
        "Prevents script execution",
        "Defers script execution until the document is loaded",
      ],
    ...
    {
      question:
        "How do you specify that a video should play automatically when the page loads?",
    ...
    {
      question:
        "Which attribute of the <a> tag in HTML is used to open the link in a new window?",
    ...
    },
    {
      ...
      possibleAnswers: [
        "Delays the execution of the script until after the document has been parsed",
        "Specifies the script to be executed immediately",
        "Indicates that the script is an external script",
      ],
      correctAnswer:
        "Delays the execution of the script until after the document has been parsed",
    ...
    {
      question:
        "In which version of HTML was the <article> element introduced?",
    ...
    {
      question:
        "Which of the following attributes is used to specify a fallback for the <video> tag?",
  ...
  csseasy: [
    ...
    {
      question:
        "What is the correct CSS syntax for making all <h1> elements bold?",
      possibleAnswers: [
        "h1 { font-weight: bold; }",
        "h1 { text-weight: bold; }",
        "h1 { font: bold; }",
    ...
    {
      question:
        "Which property is used to control the layout of a flex container?",
    ...
    {
      question:
        "Which property is used to change the spacing between characters?",
    ...
    {
      question:
        "What is the correct way to apply styles to an element with the class 'box'?",
  ...
  cssmedium: [
    ...
    {
      question:
        "Which CSS property is used to add space between the lines of text?",
  ...
  csshard: [
    {
      ...
      hint: "It's based on the root element's font size.",
    },
    {
      ...
      hint: "It's used to create two-dimensional layouts with rows and columns.",
    },
    {
      question:
      ...
      possibleAnswers: [
        ...
        "Relative positioning is absolute to the viewport",
        "There is no difference",
      ],
      correctAnswer:
        "Absolute positioning is relative to the nearest positioned ancestor",
      hint: "One is positioned based on the nearest ancestor, the other uses its normal position.",
    },
    {
      question: "How does the 'display: none;' property affect an element?",
      possibleAnswers: [
        "The element is removed from the document flow",
        "The element is hidden but takes up space",
        "The element is still accessible",
      ],
      correctAnswer: "The element is removed from the document flow",
      hint: "It removes the element completely from the page layout.",
    },
    {
      ...
      hint: "It defines the structure of columns in a grid.",
    },
    {
      question: "What is the 'flex-grow' property used for?",
      possibleAnswers: [
        "Defines how much a flex item will grow relative to the rest",
        "Defines the size of the flex container",
        "Defines the order of flex items",
      ],
      correctAnswer:
        "Defines how much a flex item will grow relative to the rest",
      hint: "It controls how much a flex item grows compared to others.",
    },
    {
      question: "What is a CSS variable?",
      possibleAnswers: [
        "A value that can be reused throughout a stylesheet",
        "A property that changes based on conditions",
        "A method of importing styles",
      ],
      correctAnswer: "A value that can be reused throughout a stylesheet",
      hint: "You can reuse this value throughout your stylesheet.",
    },
    {
      question: "What does the 'filter' property do?",
      possibleAnswers: [
        "Applies graphical effects like blurring or color shifting",
        "Changes the opacity of an element",
        "Changes the size of an element",
      ],
      correctAnswer:
        "Applies graphical effects like blurring or color shifting",
      hint: "You can use it to add visual effects like blur or brightness adjustments.",
    },
    {
      ...
      hint: "This property smoothens changes between CSS states over time.",
    },
    {
      question: "What is the purpose of the 'clip-path' property?",
      possibleAnswers: [
        "Defines a visible area of an element",
        "Sets the position of an element",
        "Creates a shadow effect",
      ],
      correctAnswer: "Defines a visible area of an element",
      hint: "It defines a visible portion of an element, cropping the rest.",
    },
    {
      ...
      hint: "It helps define named sections in a grid layout.",
    },
    {
      ...
      hint: "Use this to select elements based on their order.",
    },
    {
      question: "What does the 'backface-visibility' property do?",
      possibleAnswers: [
        "Controls whether the back face of an element is visible when turned",
        "Controls the z-index of an element",
        "Sets the opacity of an element",
      ],
      correctAnswer:
        "Controls whether the back face of an element is visible when turned",
      hint: "It determines whether you can see the back of an element when it's flipped.",
    },
    {
      question: "What is a CSS reset?",
      possibleAnswers: [
        "A set of styles that remove default browser styles",
        "A method to optimize CSS",
        "A tool for debugging",
      ],
      correctAnswer: "A set of styles that remove default browser styles",
      hint: "It removes default styles applied by browsers.",
    },
    {
      question: "How do you create responsive typography using CSS?",
      possibleAnswers: [
      ...
      hint: "Use units based on the size of the viewport.",
    },
    {
      question: "What is the use of the ':nth-of-type()' selector?",
      possibleAnswers: [
        "Selects elements based on their type and position",
        "Selects all elements of a given type",
        "Selects elements by class name",
      ],
      correctAnswer: "Selects elements based on their type and position",
      hint: "It selects elements based on their order within their type.",
    },
    {
      ...
      hint: "This property defines the size of columns in a grid.",
    },
    {
      question: "What is the purpose of the 'will-change' property?",
      possibleAnswers: [
        "Hints the browser about what properties will change",
        "Creates animations",
        "Sets opacity",
      ],
      correctAnswer: "Hints the browser about what properties will change",
      hint: "It hints the browser about what elements will be animated or changed.",
    },
    {
      question: "How do you create a hover effect with a transition?",
      possibleAnswers: [
        "Using ':hover' with the 'transition' property",
        "Using ':hover' with 'animation'",
        "Using 'hover' only",
      ],
      correctAnswer: "Using ':hover' with the 'transition' property",
      hint: "Combine this pseudo-class with smooth transition effects.",
    },
    {
      question: "What is the purpose of the 'object-fit' property?",
      possibleAnswers: [
        "Defines how an image or video should be resized",
        "Sets the position of an image",
        "Controls the opacity of an image",
      ],
      correctAnswer: "Defines how an image or video should be resized",
      hint: "It defines how an image or video scales inside its container.",
    },
    {
      ...
      hint: "It applies both 2D and 3D transformations like scaling and rotating.",
    },
    {
      question: "How do you control the flow of content in a grid layout?",
      possibleAnswers: [
        "Using the 'grid-auto-flow' property",
        "Using the 'grid-template-areas' property",
        "Using the 'grid-gap' property",
      ],
      correctAnswer: "Using the 'grid-auto-flow' property",
      hint: "This property dictates whether grid items flow by row or column.",
    },
    {
      question:
        "What is the purpose of the 'align-items' property in a flex container?",
      possibleAnswers: [
      ...
      hint: "It aligns flex items vertically within the flex container.",
    },
    {
    ...
    },
    {
      ...
      correctAnswer:
        "Controls whether flex items should wrap onto multiple lines",
      hint: "It decides whether flex items will stay in one line or wrap onto multiple lines.",
    },
    {
      question: "What is a media feature in CSS?",
      possibleAnswers: [
        "A characteristic of a device or browser",
        "A type of CSS rule",
        "A property of an element",
      ],
      correctAnswer: "A characteristic of a device or browser",
      hint: "It refers to a characteristic like screen size or orientation.",
    },
    {
      question: "How can you create animations using CSS?",
      possibleAnswers: [
        "Using the '@keyframes' rule and 'animation' property",
        "Using the 'transition' property",
        "Using the 'transform' property",
      ],
      correctAnswer: "Using the '@keyframes' rule and 'animation' property",
      hint: "Define keyframes and specify the changes that happen over time.",
    },
  ],
  ...
  jseasy: [
    {
      ...
      hint: "Use this method to log information to the browser's console.",
    },
    {
      question: "Which symbol is used for comments in JavaScript?",
      possibleAnswers: ["//", "#", "/*"],
      correctAnswer: "//",
      hint: "This symbol is used for single-line comments.",
    },
    {
      question: "How do you declare a variable in JavaScript?",
      possibleAnswers: ["var name;", "variable name;", "declare name;"],
      correctAnswer: "var name;",
      hint: "Use this keyword to declare variables in ES5.",
    },
    {
      question: "Which data type is NOT supported in JavaScript?",
      possibleAnswers: ["undefined", "string", "character"],
      correctAnswer: "character",
      hint: "JavaScript strings are made of characters, but it doesn't have a 'character' data type.",
    },
    {
      ...
      hint: "You can create arrays in two different ways.",
    },
    {
      question: "What does 'NaN' stand for in JavaScript?",
      possibleAnswers: ["Not a Number", "Not a Null", "Not an Object"],
      correctAnswer: "Not a Number",
      hint: "It indicates a value that is not a legal number.",
    },
    {
      ...
      correctAnswer: "// This is a comment",
      hint: "Use this symbol for single-line comments.",
    },
    {
      question: "Which of the following is a JavaScript framework?",
      possibleAnswers: ["React", "HTML", "CSS"],
      correctAnswer: "React",
      hint: "This is a popular front-end library developed by Facebook.",
    },
    {
      question: "What is the output of 2 + '2' in JavaScript?",
      possibleAnswers: ["22", "4", "Error"],
      correctAnswer: "22",
      hint: "When you add a number and a string, it performs concatenation.",
    },
    {
      ...
      hint: "This is the standard way to define functions.",
    },
    {
      question:
      ...
      hint: "Use this method to target an element by its ID.",
    },
    {
      ...
      hint: "Use this keyword to declare a value that cannot be reassigned.",
    },
    {
      ...
      hint: "It checks the data type of a given variable.",
    },
    {
      question: "Which operator is used to assign a value to a variable?",
      possibleAnswers: ["=", "==", "==="],
      correctAnswer: "=",
      hint: "This operator is used for assigning values to variables.",
    },
    {
      ...
      correctAnswer: "Both of the above",
      hint: "You can use either of these methods for type conversion.",
    },
    {
      question: "Which event occurs when the user clicks on an HTML element?",
      possibleAnswers: ["onclick", "onchange", "onmouseclick"],
      correctAnswer: "onclick",
      hint: "This event is triggered when an element is clicked.",
    },
    {
      ...
      hint: "'this' refers to the object it's called within.",
    },
    {
      question:
      ...
      correctAnswer: "1",
      hint: "In JavaScript, 'true' is 1 and 'false' is 0.",
    },
    {
      question:
    ...
    },
    {
      ...
      correctAnswer: "object",
      hint: "Despite its name, this value is considered an object due to a quirk in JavaScript.",
    },
  ],
  ...
  jsmedium: [
    {
      ...
      hint: "'==' performs type coercion, while '===' does not.",
    },
    {
      question: "What is a closure in JavaScript?",
      possibleAnswers: [
        "A function that has access to its parent's scope",
        "A way to hide variables",
        "A type of loop",
      ],
      correctAnswer: "A function that has access to its parent's scope",
      hint: "Closures allow a function to remember its lexical scope.",
    },
    {
      ...
      hint: "Promises represent the eventual completion (or failure) of an asynchronous operation.",
    },
    {
      ...
      hint: "This technique improves performance by minimizing the number of event listeners.",
    },
    {
      ...
      hint: "This structure allows you to catch and handle exceptions.",
    },
    {
      ...
      hint: "It allows you to write promise-based code as if it were synchronous.",
    },
    {
      question: "What is the use of the 'bind' method in JavaScript?",
      possibleAnswers: [
        "Creates a new function that, when called, has its 'this' set to a specific value",
        "Binds an event listener",
        "Creates a new object",
      ],
      correctAnswer:
        "Creates a new function that, when called, has its 'this' set to a specific value",
      hint: "Use 'bind' to ensure a function is called with a specific context.",
    },
    {
      ...
      hint: "Modules help organize and encapsulate code.",
    },
    {
      ...
      hint: "This API is used to perform asynchronous HTTP requests.",
    },
    {
      ...
      correctAnswer:
        "'var' is function-scoped, 'let' and 'const' are block-scoped",
      hint: "'let' and 'const' were introduced in ES6 for better scoping.",
    },
    {
      ...
      correctAnswer:
        "A way to unpack values from arrays or properties from objects",
      hint: "It allows for more readable code when extracting values.",
    },
    {
      ...
      hint: "You can use it to combine arrays or to spread elements.",
    },
    {
      question:
      ...
      possibleAnswers: [
        ...
        "There is no difference",
        "Function expressions are named",
      ],
      correctAnswer:
        "Function declarations are hoisted, function expressions are not",
      hint: "Hoisting allows function declarations to be used before they are defined.",
    },
    {
      ...
      possibleAnswers: [
        ...
        "Maps elements of an array",
      ],
      correctAnswer: "Executes a reducer function on each element of the array",
      hint: "It can transform an array into a single value.",
    },
    {
      ...
      hint: "This method handles nested objects.",
    },
    {
      ...
      correctAnswer:
        "Executes a function after a specified number of milliseconds",
      hint: "It is useful for delaying the execution of code.",
    },
    {
      ...
      correctAnswer:
        "Creates a new array with the results of calling a provided function on every element",
      hint: "This method applies a function to each element and returns a new array.",
    },
    {
      ...
      hint: "It returns true or false based on the check.",
    },
    {
      ...
      hint: "It's used for serializing data.",
    },
  ],
  ...
  jshard: [
    {
      ...
      hint: "Symbols are often used as keys for object properties to avoid name clashes.",
    },
    {
      question: "What is the event loop in JavaScript?",
      possibleAnswers: [
        "A mechanism that allows asynchronous code to be executed",
        "A way to create loops",
        "A type of event",
      ],
      correctAnswer: "A mechanism that allows asynchronous code to be executed",
      hint: "It manages the execution of code, events, and message handling.",
    },
    {
      ...
      hint: "It's useful for handling multiple asynchronous operations simultaneously.",
    },
    {
      ...
      possibleAnswers: [
        ...
        "A reference that cannot be accessed",
      ],
      correctAnswer: "A reference that does not prevent garbage collection",
      hint: "Weak references are created using the 'WeakMap' or 'WeakSet' structures.",
    },
    {
      question: "What does the 'bind' method return?",
      possibleAnswers: [
        "A new function with a specific 'this' value",
        "The original function",
        "An object",
      ],
      correctAnswer: "A new function with a specific 'this' value",
      hint: "It allows you to set the value of 'this' when calling the function.",
    },
    {
      ...
      correctAnswer:
        "Objects inherit properties and methods from other objects",
      hint: "JavaScript uses prototypes to allow objects to share methods and properties.",
    },
    {
      ...
      hint: "A promise can be in one of these three states during its lifecycle.",
    },
    {
      ...
      hint: "This syntax allows you to write asynchronous code in a more readable way.",
    },
    {
      question: "What does the 'setImmediate' function do?",
      possibleAnswers: [
        "Executes a single operation after the current event loop cycle",
        "Executes code immediately",
        "Creates a delay in code execution",
      ],
      correctAnswer:
        "Executes a single operation after the current event loop cycle",
      hint: "It's useful for deferring execution until the next iteration of the event loop.",
    },
    {
      question: "What is the difference between 'call()' and 'apply()'?",
      possibleAnswers: [
        "'call()' takes arguments separately, 'apply()' takes an array of arguments",
        "'call()' creates a new function, 'apply()' does not",
        "'call()' does not change 'this', 'apply()' does",
      ],
      correctAnswer:
        "'call()' takes arguments separately, 'apply()' takes an array of arguments",
      hint: "Both methods invoke a function with a specified 'this' value.",
    },
    {
      ...
      hint: "It takes two arguments: a function and the interval time in milliseconds.",
    },
    {
      ...
      hint: "It initializes a new object based on a constructor function.",
    },
    {
      ...
      hint: "This design pattern ensures that a class has only one instance.",
    },
    {
      ...
      hint: "They allow you to define custom logic when accessing or modifying properties.",
    },
    {
      ...
      correctAnswer:
        "Checks if an object is an instance of a specific class or constructor",
      hint: "It is often used for type checking.",
    },
    {
      question:
        "What is the difference between synchronous and asynchronous code?",
      possibleAnswers: [
        "Synchronous code runs sequentially, asynchronous code runs concurrently",
        "Asynchronous code runs sequentially, synchronous code runs concurrently",
        "There is no difference",
      ],
      correctAnswer:
        "Synchronous code runs sequentially, asynchronous code runs concurrently",
      hint: "Synchronous code blocks execution, while asynchronous code allows other tasks to run.",
    },
    {
      ...
      possibleAnswers: [
        ...
        "A type of promise",
        "A way to create a closure",
      ],
      correctAnswer:
        "A function that wraps an expression to delay its evaluation",
      hint: "Thunks are often used in functional programming.",
    },
    {
      ...
      hint: "This method allows for inheritance without the constructor function.",
    },
  ],
};
